      ...
      <div className="w-[800px]  h-[600px] relative flex justify-center items-center ">
        ...
        {cercelData.map((item, index) => (
          <div
            ...
            className="absolute hover:scale-105 cursor-pointer  overflow-y-scroll    shadow-md shadow-black flex justify-center items-center  border border-black   min-h-[200px] min-w-[200px]  rounded-full"
          >
            {dataIndex.includes(index) ? (
              <div className=" w-[150px] h-[150px] text-[18px]  pl-2  rounded-full  text-center ">
                {item.text}
              </div>
            ) : (
